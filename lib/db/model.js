...
/**
 * SQL definition for public.deck_suggestion
 */
exports.DeckSuggestion = sql.define({
    name: 'deck_suggestion',
    columns: [
        { name: 'id' },
        { name: 'name' },
        { name: 'description' },
...
/**
 * SQL definition for public.black_card_suggestion
 */
exports.BlackCardSuggestion = sql.define({
    name: 'black_card_suggestion',
    columns: [
        { name: 'id' },
        { name: 'deck_id' },
        { name: 'deck_suggestion_id' },
        { name: 'text' },
        { name: 'pick' },
        { name: 'author_id' }
    ]
...
/**
 * SQL definition for public.white_card_suggestion
 */
exports.WhiteCardSuggestion = sql.define({
    name: 'white_card_suggestion',
    columns: [
        { name: 'id' },
        { name: 'deck_id' },
        { name: 'deck_suggestion_id' },
